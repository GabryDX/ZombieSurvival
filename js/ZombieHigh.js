export function Zombie(){		
        ...
        var body_geometry      = new THREE.BoxGeometry( 1.4/3, 0.7, 0.7/3);
        var head_geometry      = new THREE.BoxGeometry( 1.4/3, 1.4/3, 1.4/3);
        var left_leg_geometry  = new THREE.BoxGeometry( 0.7/3, 0.7, 0.7/3);
        var right_leg_geometry = new THREE.BoxGeometry( 0.7/3, 0.7, 0.7/3);
        var left_arm_geometry  = new THREE.BoxGeometry( 0.7/3, 0.7, 0.7/3);
        var right_arm_geometry = new THREE.BoxGeometry( 0.7/3, 0.7, 0.7/3);                                                                                                
        ...
        var base_len = left_leg_geometry.parameters.height/2;
        ...
        left_leg.position.set(-left_leg_geometry.parameters.width/2, base_len, 0);
        right_leg.position.set(right_leg_geometry.parameters.width/2, base_len, 0);
        left_arm.position.set(-(body_geometry.parameters.width+left_arm_geometry.parameters.width)/2, base_len+left_arm_geometry.parameters.height*1.3, -right_leg_geometry.parameters.height/4);
        right_arm.position.set((body_geometry.parameters.width+right_arm_geometry.parameters.width)/2, base_len+right_arm_geometry.parameters.height*1.3, -right_leg_geometry.parameters.height/4);
}